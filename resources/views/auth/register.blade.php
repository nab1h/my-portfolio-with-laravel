    ...
    <div class="w-full max-w-md">
        ...
        <div class="bg-white rounded-2xl shadow-xl p-8">
            <form action="{{url('/register')}}" method="POST">
                ...
                <div class="mb-6">
                    <label class="flex items-start">
                        <input type="checkbox" name="terms" class="w-4 h-4 mt-1 text-indigo-600 border-gray-300 rounded focus:ring-indigo-500" required>
                        <span class="ml-2 text-sm text-gray-600">I agree to the <a href="#" class="text-indigo-600 hover:text-indigo-800 font-medium">Terms of Service</a> and <a href="#" class="text-indigo-600 hover:text-indigo-800 font-medium">Privacy Policy</a></span>
                    </label>
                </div>
            ...
            <div class="grid grid-cols-2 gap-4">
                <button class="flex items-center justify-center gap-2 border border-gray-300 py-3 rounded-lg hover:bg-gray-50 transition">
        ...
        <p class="text-center mt-6 text-gray-600">
            ...
            <a href="#" class="text-indigo-600 hover:text-indigo-800 font-semibold">Sign in</a>
        </p>
